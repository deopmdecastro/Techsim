...
export function IconRail({ active = 'edit', onNavigate }) {
  ...
  if (collapsed) {
    return (
      <aside className="techsim-nav-shell flex h-full w-[84px] shrink-0 flex-col items-center gap-4 border-r border-white/8 px-3 py-4">
        <button
          type="button"
  ...
  return (
    <aside className="techsim-nav-shell flex h-full w-[112px] shrink-0 flex-col border-r border-white/8 px-3 py-4 transition-[width] duration-200">
